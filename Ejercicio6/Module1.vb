...
Module Module1
	Sub Main()
		...
		Dim Ent1, Ent2, result As Double
		Do
			Try
				Console.Clear()
			...
			Select Case opcion
				...
				Case "2"
					Try
						...
						result = ((9 / 5) * Ent1) + 32
						Console.WriteLine("El resultado en Fahrenheit es: " & result)
						Dim Salida As StreamWriter
						Salida = File.AppendText("Salida.txt")
						Salida.WriteLine(nombre & "," & Ent1 & "," & result)
						Salida.Close()
				...
				Case "3"
					...
					Try
						...
						Console.WriteLine("Nombre, Temp C, Temp F")
