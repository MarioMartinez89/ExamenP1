...
Module Module1
	Sub Main()
		...
		Dim Ent1, Ent2, Ent3, result As Double
		Do
			Try
				Console.Clear()
			...
			Select Case opcion
				...
				Case "2"
					Try
						...
						Console.WriteLine("Ingrese la cantidad en años")
						Ent2 = Console.ReadLine()
						Console.WriteLine("Ingrese la tasa de interes anual sin %")
						Ent3 = Console.ReadLine()
						result = Ent1 * ((1 + (Ent3 / 100)) ^ (Ent2))
						Console.WriteLine("El resultado es: " & result)
						Dim Salida As StreamWriter
						Salida = File.AppendText("Salida.txt")
						Salida.WriteLine(nombre & "," & Ent1 & "," & Ent2 & "," & Ent3 & "," & result)
						Salida.Close()
				...
				Case "3"
					...
					Try
						...
						Console.WriteLine("Nombre, Valor invertido, Años, Tasa Interes %, Monto Final")
